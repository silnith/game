...
public class SampleSearcherTest {
	...
	private static class TicTacToe implements Game<Move<Board>, Board> {
		...
		public Collection<Move<Board>> findAllMoves(
				GameState<Move<Board>, Board> state) {
			ArrayList<Move<Board>> moves = new ArrayList<>();
		...
		@Override
		public GameState<Move<Board>, Board> pruneGameState(GameState<Move<Board>, Board> state) {
			return state;
		}
	...
	public static void main(final String[] args) throws InterruptedException, ExecutionException {
		...
		final Searcher<Move<Board>, Board> searcher = new Searcher<>(new TicTacToe(),
				new GameState<>(initialMove, initialBoard));
