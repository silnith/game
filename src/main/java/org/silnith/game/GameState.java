...
/**
 * A single node in a game tree.  This keeps track of the history of a game,
 * both the sequence of moves made from the beginning and the state of the board
 * after every move.
 * 
 * <p>It is assumed that {@code node.getMoves().size() == node.getBoards().size()}.
 * 
