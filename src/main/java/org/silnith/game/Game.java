...
public interface Game<M extends Move<B>, B> {
	...
	/**
	 * Returns all the legal moves for the provided game state.  The current
	 * game board can be retrieved using {@code state.getBoards().get(0)}.
	 * 
	 * <p>The set of moves returned may vary depending on the configuration of
	 * the game engine.  See the individual engines for configuration parameters.
	 * 
